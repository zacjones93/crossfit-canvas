...
export const metadata: Metadata = {
  ...
  description: "Learn about CrossFit Canvas in Caldwell, ID. Our mission, values, coaches, and commitment to helping you change your life through fitness.",
};
      ...
      <section className="bg-black py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto space-y-6 text-white">
            ...
            <div className="space-y-4 text-base md:text-lg">
              <p>
                CrossFit Canvas has been serving the Caldwell, Idaho community for years,
                focusing on supporting people ready to take action on their fitness goals.
              </p>

              <p>
                We understand that working out is challenging, but accessibility and convenience
                should never be barriers to your success. Whether you&apos;re just starting out or
                are a seasoned athlete, you&apos;ll find support, encouragement, and accountability
                from our coaches and fellow members.
              </p>

              <p>
                We believe in supporting people who are ready to take action and give them
                everything they need to crush their goals. It&apos;s why our members keep coming
                back for more.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Our experienced coaching team is dedicated to helping you reach your goals
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-card rounded-lg border p-8 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-heading text-2xl font-bold mb-3">Location</h3>
                    <p className="text-base leading-relaxed">
                      4611 Enterprise Way<br />
                      Caldwell, Idaho 83605
                    </p>
                    <p className="text-sm text-muted-foreground mt-3">
                      Conveniently located off Franklin on the east side of the freeway near Crunch Fitness
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg border p-8 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="font-heading text-2xl font-bold mb-3">Hours</h3>
                    <p className="text-base leading-relaxed">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-black text-base font-bold uppercase px-8 py-6 h-auto rounded-[4px] transition-all"
              >
                <a href="/schedule">
                  View Schedule
                </a>
