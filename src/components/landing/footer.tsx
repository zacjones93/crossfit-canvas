...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-white">
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="h-[3px] w-24 bg-[#DC143C] mb-4" />
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-gray-400 hover:text-[#DC143C] transition-colors"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/about" className="group font-sans text-gray-400 hover:text-white transition-colors relative">
                  About Us
                  <span className="absolute left-0 -bottom-0.5 w-0 h-[2px] bg-[#DC143C] transition-all group-hover:w-full" />
                </Link>
              </li>
              <li>
      ...
      <div className="border-t border-[#DC143C]">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p className="font-sans">© {currentYear} CrossFit Canvas. All rights reserved.</p>
            <div className="flex gap-6 items-center">
              <Link href="/privacy" className="font-sans hover:text-[#DC143C] transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="font-sans hover:text-[#DC143C] transition-colors">
                Terms of Service
              </Link>
              <ThemeSwitch />
            </div>
